...
<body>
    ...
    <div class="main-menu-area mg-tb-40">
        <div class="container">
            <div class="row">
                <div class="col-10">
                <h1 class="mt-3">Daftar Wisata</h1>
                <br/>
                <form action="/search" method="GET">
                    <input type="text" name="cari" placeholder="Cari Wisata" class="form-control">
                ...
                @foreach($wisatas as $wisatas)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        {{ $wisatas->id }}. {{ $wisatas->nama }}
                        <a href="/datawisata/{{ $wisatas->id }}" class="badge badge-info">detail</a>
                    </li>
                @endforeach
                </ul>
                </div>
