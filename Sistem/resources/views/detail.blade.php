...
<body>
            ...
            <div class="col-10">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            No. Telpon      : {{$wisata->notelp}} <br/>
                            Jam Operasional : {{$wisata->buka}} - {{$wisata->tutup}} <br/>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($kunjungans as $kunjungans)
                                @if($kunjungans->idwisata == $wisata->id)
                                    <tr>
                                    <td> {{$kunjungans->created_at}} </td>
                                    <td> {{$kunjungans->jumlah}} </td>
                                    <td> {{ ( $kunjungans->jumlah / $kunjungans->kapasitaswisata ) * 100 }}% </td>
                                @endif
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if($reviews->idwisata == $wisata->id)
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">{{$reviews->emailuser}}</h6>
                                    <p class="card-text">{{$reviews->rating}}<br/>{{$reviews->komen}}</p>
                                </div>
                            </div>
                        @endif
                        @endforeach
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Riwayat Pengajuan Pembinaan</h5>
                        <p class="card-text">
                        <table class="table">
                            <thead class="thead-dark">
                                <tr>
                ...
                <br/>
                <a class="btn btn-primary" href="{{ url('/datawisata') }}" role="button">Kembali</a>
                <br/>
            </div>
        </div>
    </div>
    ...
    <!-- Start Footer area-->
    <footer class="footer-copyright-areahome">
        <div class="container">
            <div class="row">
                <div class="col-lg-25 col-md-12 col-sm-12 col-xs-12">
