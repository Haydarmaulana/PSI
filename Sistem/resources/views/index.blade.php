...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a href="/datawisata"> Daftar Wisata</a>
                        </li>

                        <li><a href="/dataajuan">Daftar Ajuan</a>
                        </li>
                    </ul>
    ...
    <div class="main-menu-area mg-tb-70">
    <div class="container">
        <div class="row">
            <div class="col-10">
            ...
            <table class="table">
                <thead class="thead-dark">
                    ...
                    <th scope="col">Rata rata jumlah pengunjung</th>
                    <th scope="col">Kapasitas</th>
                    <th scope="col">Persentase pengunjung</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($kunjungans as $kunjungans)
                    @if($kunjungans->created_at == '2020-07-01')
                    <tr>
                    <td> {{$kunjungans->namawisata}} </td>
                    <td> {{$kunjungans->jumlah}} </td>
                    <td> {{$kunjungans->kapasitas}} </td>
                    <td>
                    {{ ( $kunjungans->jumlah / $kunjungans->kapasitas ) * 100}}% </td>
                    @endif
                    @endforeach
                </tbody>
            </table>

            <h7 class="mt-3">Diperbarui pada : 2020-07-01</h7>
...
. All rights reserved.</p>
    ...
    Highcharts.chart('chartKunjungan', {
        ...
        title: {
            text: 'Data kunjungan wisata bulan ini'
        },
        xAxis: {
